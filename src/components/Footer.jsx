...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#020510] border-t border-white/[0.06] pt-20 pb-10 overflow-hidden">
      ...
      {/* Bottom glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[260px] rounded-full pointer-events-none"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-[1.6fr_repeat(4,1fr)] gap-10 mb-14">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-[11px] font-mono tracking-[0.13em] uppercase text-white/30 mb-2">Stay in the loop</p>
            {done ? (
            ...
            <div className="flex gap-2.5 mt-5">
              {SOCIAL.map((s) => (
                <a key={s.s} href={s.h} target="_blank" rel="noreferrer"
          ...
          {COLS.map((col) => (
            <div key={col.title}>
              <p className="text-[11px] font-semibold font-mono tracking-[0.13em] uppercase text-white/32 mb-3.5">{col.title}</p>
              <div className="flex flex-col gap-2.5">
                {col.links.map((link) => (
                  <Link key={link.l} to={link.h}
